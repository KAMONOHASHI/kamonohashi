    ...
    <el-form ref="createForm" :model="this" :rules="rules">
      ...
      <div style="padding-left: 30px; padding-right: 10px;">
        ...
        <el-form-item label="URL" prop="registryUrl">
          <el-switch v-model="editRegistryUrl" :disabled="isNotEditable" />
          <el-input
            v-model="registryUrl"
            :disabled="isNotEditable || !editRegistryUrl"
          />
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    async retrieveData() {
      ...
      this.editRegistryUrl =
        defaultProtocol + result.host + ':' + result.portNo !==
        result.registryUrl
    },
