...
export default {
  ...
  methods: {
          ...
          try {
            let params = {
              ...
              model: {
                ...
                assignedTenantIds:
                  this.accessLevel === 1 ? this.selectedTenants : [],
    ...
    async retrieveData() {
      ...
      this.selectedTenants = result.assignedTenants
        ? result.assignedTenants.map(t => {
            return t.id
          })
        : []
