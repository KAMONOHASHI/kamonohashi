  ...
  <el-dialog class="dialog"
    ...
    <el-form :model="this"
      ...
      <el-form-item label="実行コマンド" prop="entryPoint">
        <div v-if="isPatch">
          <el-input type="textarea" :autosize="{ minRows: 2}" v-model="entryPoint" :readonly="true"/>
        </div>
        <div v-else>
        ...
        <el-col :span="12">
          ...
          <div v-else>
            <el-form-item label="コンテナ" prop="selectedContainer">
              <pl-container-selector v-model="selectedContainer"></pl-container-selector>
            </el-form-item>
            <el-form-item label="Git" prop="selectedGit">
              <pl-git-selector v-model="selectedGit" :loading.sync="loadingGit"></pl-git-selector>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
      ...
      <el-row>
        <el-col class="button-group">
          ...
          <pl-delete-button class="pull-left btn-update" @delete="handleRemove" :disabled="isPatch"/>
        </el-col>
      </el-row>
    </el-form>
  </el-dialog>
      ...
      async changeId () {
        if (this.id) {
          ...
          try {
            ...
            let [historyData] = api.f.data(await api.preprocessings.getHistory(params))
