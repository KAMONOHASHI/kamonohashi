        ...
        <div class="cp_tab">
          ...
          <div class="cp_tabpanels">
            <div id="first_tab01" class="cp_tabpanel">
              <el-form ref="userForm" :rules="userRules" :model="userForm">
                <el-form-item
                  :label="$t('defaultTenant')"
                  prop="tenants"
                  :label-width="labelwidth"
                >
                  <el-select
                    v-if="userForm.tenants"
                    v-model="userForm.defaultTenant.name"
                    placeholder="Select"
                    :clearable="true"
                  >
                    <el-option
            ...
            <div id="force_tab01" class="cp_tabpanel">
              ...
              <div v-else>
                ...
                >
                  <el-form-item
                    :label="$t('selectedRegistry')"
                    :label-width="labelwidth"
                  >
                    <pl-registry-selecter
    ...
    async init() {
      try {
        ...
        for (let i = 0; i < this.registryForm.registries.length; i++) {
          if (
            this.registryForm.registryId === this.registryForm.registries[i].id
          ) {
            this.registryForm.name = this.registryForm.registries[i].name
            this.registryForm.userName = this.registryForm.registries[
              i
            ].userName
            this.registryForm.password = this.registryForm.registries[
              i
            ].password
          }
        }
