...
namespace Nssol.Platypus.Migrations
{
    public partial class v320 : Migration
    {
        ...
        {
            // Migrationの自動生成時に作られたソースコードであるが、
            // DBの切戻しをしようとするとエラーが発生する。
            // Serial型から、Identity型への変換はできないためである。
            // 
            // 以前のバージョンへのバージョンダウンはサポートしないこととする。
            // そのため、DBの切戻し対応は行わない（させない）ため、
            // あえてエラーになるソースコードを残している。
