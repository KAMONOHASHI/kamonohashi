...
class TrainingApiModelsCreateInputModel(object):
    ...
    def __init__(self, container_image=None, cpu=None, data_set_id=None, entry_point=None, git_model=None, gpu=None, memo=None, memory=None, name=None, options=None, parent_ids=None, partition=None, ports=None, tags=None, zip=None):  # noqa: E501
